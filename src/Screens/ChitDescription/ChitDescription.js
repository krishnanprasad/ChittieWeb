        ...
        return (
            <div className="ChitDescription">
                ...
                <div class="d-flex" style={{ marginTop: '20px' }}>
                    ...
                    <div class="p-2"><button type="button" className="btn">Apply Loan</button> <Link to="/Home/Group/ChitDescription/MCT2014/Payment"><button type="button" className="btn btn-success">Pay EMI</button></Link></div>
                </div>
